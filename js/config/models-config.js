 ...
 * Contiene todos los datos de modelos, codificaciones e información de compañías
 */

// Mapeo de codificaciones de modelos a sus identificadores
const MODEL_ENCODINGS = {
    ...
    'claude-3.5-sonnet': 'cl100k_base', // Aproximación
    'claude-3-opus': 'cl100k_base',
    'claude-3-sonnet': 'cl100k_base',
    'claude-3-haiku': 'cl100k_base',
    'gemini-1.5-pro': 'cl100k_base', // Aproximación
    'gemini-1.5-flash': 'cl100k_base',
    'llama-3.1-405b': 'cl100k_base', // Aproximación
    'llama-3.1-70b': 'cl100k_base',
    'llama-3.1-8b': 'cl100k_base',
    'llama-3-70b': 'cl100k_base',
    'llama-3-8b': 'cl100k_base',
    'mistral-large': 'cl100k_base', // Aproximación
    'mistral-nemo': 'cl100k_base',
    'mixtral-8x7b': 'cl100k_base',
    'mixtral-8x22b': 'cl100k_base',
    'command-r+': 'cl100k_base', // Aproximación
    'command-r': 'cl100k_base',
    'qwen2.5-72b': 'cl100k_base', // Aproximación
    'qwen2-72b': 'cl100k_base',
    'deepseek-v2.5': 'cl100k_base', // Aproximación
    'deepseek-v2': 'cl100k_base',
    'yi-large': 'cl100k_base', // Aproximación
    'yi-1.5-34b': 'cl100k_base',
    'phi-3.5-mini': 'cl100k_base', // Aproximación
    'phi-3-medium': 'cl100k_base',
    'phi-3-mini': 'cl100k_base',
    'granite-3-8b': 'cl100k_base', // Aproximación
    'granite-3-2b': 'cl100k_base',
    'jamba-1.5-large': 'cl100k_base', // Aproximación
    'jamba-1.5-mini': 'cl100k_base',
    'grok-2': 'cl100k_base', // Aproximación
    'grok-2-mini': 'cl100k_base',
    'reka-core': 'cl100k_base', // Aproximación
    'reka-flash': 'cl100k_base',
    'titan-text-premier': 'cl100k_base', // Aproximación
    'titan-text-express': 'cl100k_base',
    'llama-3.1-sonar-large': 'cl100k_base', // Aproximación
    'llama-3.1-sonar-small': 'cl100k_base',
    'arctic': 'cl100k_base', // Aproximación
    'hermes-3-405b': 'cl100k_base', // Aproximación
    'hermes-3-70b': 'cl100k_base',
    'nemotron-70b': 'cl100k_base', // Aproximación
    'nemotron-mini': 'cl100k_base'
};

// Información de compañías y branding
const COMPANIES = {
...
// Configuración completa de datos de modelos
const MODELS_DATA = {
    'gpt-4o': {
        name: 'GPT-4o',
        company: 'OpenAI',
